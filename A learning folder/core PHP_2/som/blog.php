  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header vichwa1" style="padding:35px 50px;">
        ...
        <div class="modal-footer">
          ...
          <p>Not a member? 
      <button type="button" data-toggle="modal" data-target="#test2" class="modal12">Signup</button>
          <br>Forgot <a href="#" class="modal12">Password?</a></p>
      <div id="test2" class="modal fade" role="dialog" style="z-index: 1600;">
        <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close closex" data-dismiss="modal" >&times;</button>
          <h4 class="vichwa">SignUp to Somali laundry</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form">
            <div class="form-group">
              <center> <label for="usrname"><span class="glyphicon glyphicon-user modal22"></span class="modal22"> First Name</label></center> 
              <input type="text" class="form-control" id="usrname" placeholder="Enter email">
            </div>
      <div class="form-group">
              <center> <label for="usrname"><span class="glyphicon glyphicon-user"></span> Last Name</label></center> 
              <input type="text" class="form-control" id="usrname" placeholder="Enter email">
            </div>
      <div class="form-group">
             <center> <label for="usrname"><span class="glyphicon glyphicon-envelope"></span> Email Adress</label></center>
              <input type="text" class="form-control" id="usrname" placeholder="Enter email">
            </div>
             <div class="form-group">
              <center> <label for="usrname"><span class="glyphicon glyphicon-user"></span> Contact Number</label></center> 
              <input type="text" class="form-control" id="usrname" placeholder="Enter email">
            </div>
            <div class="form-group">
              <center><label for="psw"><span class="glyphicon glyphicon-briefcase"></span> Student ID </label></center>
              <input type="text" class="form-control" id="psw" placeholder="Enter password">
            </div>
            <div class="form-group">
              <center><label for="psw"><span class="glyphicon glyphicon-eye-open"></span> New Password</label></center>
              <input type="text" class="form-control" id="psw" placeholder="Enter password">
            </div>
      <div class="form-group">
              <center><label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Confirm Password</label></center>
              <input type="text" class="form-control" id="psw" placeholder="Enter password">
            </div>
            <div class="checkbox">
              <label><input type="checkbox" value="" checked>Remember me</label>
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="blogs">
          <div class="text-center">
            <h2>Somali Blog</h2>
            <p>Somali laundry<br>Let us do your laundry and dry cleaning <br>It's simple, affordable and convenient</p>
            </p>
          </div>
          <hr>
        </div>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="page-header">
          <div class="blog">
            <strong><h3 id="demo"></h3></strong>
           <script>
var d = new Date();
document.getElementById("demo").innerHTML = d;
</script>            
<img src="img/pic44.jpeg" class="img-responsive" id="img1" alt="" />

            <p>We have chairs where you can relax and enjoy a snack or just have some peace and quiet while waiting for the laundry to be done
            Fabric Softener – Fragrant paper for dryers – Free Wifi – Parking for drop-off and pick-up.</p>

            <h3> Fabric Softener</h3>

            <p>Choose between 3-7 days service or Express - finish your dry cleaning the same day.For Express service, all dry cleaning must be delivered to us latest 12 pm Monday – Friday. For service on Saturday and Sunday please send us an inquiry.Pick up 60,- / Delivery 60,-Saturday and Sundays on demand.</p>
            <div class="ficon">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="media">
              ...
              <div class="media-body">
                <h5 class="media-heading tab1">Kerry Karry</h5>
                <p>hello, People when you will start with application
                </p>
                <div class="ficon">
          ...
          <div class="panel-body">
            <div class="media">
              ...
              <div class="media-body">
               <strong> <h5 class="media-heading tab1">Ndugu Yangu</h5></strong>
                <p>i love this blog
                <div class="ficon">
                  <a href="#" alt="">Read more</a>
                </div>
          ...
          <div class="panel-body">
            <div class="media">
              ...
              <div class="media-body">
               <strong> <h5 class="media-heading tab1">lyana lily</h5></strong>
                <p>hello!!<br>
                  I think you will come at Haryana. this service its nice
                </p>
                <div class="ficon">
                  <a href="#" alt="">Read more</a>
                </div>
          ...
          <div class="panel-body">
            <div class="media">
              ...
              <div class="media-body">
                <strong><h5 class="media-heading tab1">Cute Amina</h5></strong>
                <p>daaaaah!!<br>
                  hii huduma ni nzuri saaanaaaaaa i like it
                </p>
                <div class="ficon">
                  <a href="#" alt="">Read more</a>
                </div>
              ...
              <br>
                ...
                <div class="col-12 col-sm-4 align-self-center">
                    <div class="text-center">
                        ...
                        <a class="btn btn-social-icon btn-facebook" href="https://www.facebook.com/Somali-Laundry-2158800311049804/"><i class="fa fa-facebook fa-lg"></i></a>
