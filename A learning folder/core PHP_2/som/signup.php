...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
    <center><h3>Register Now  To Somali Laundry  Service</h3></center>
  </div>
</div>
</div>
<div class="container">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-6 mustafa">
          <form role="form">
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user modal22"></span class="modal22"> First Name</label>
      ...
      <div class="form-group">
             <label for="usrname"><span class="glyphicon glyphicon-envelope"></span> Email Adress</label>
              <input type="text" class="form-control" id="email"  name="email" placeholder="Enter email">
            </div>
             <div class="form-group">
               <label for="usrname"><span class="glyphicon glyphicon-user"></span> Contact Number</label> 
              <input type="text" class="form-control" id="contact" name="contact"  placeholder="Enter email">
            </div>
            <div class="form-group">
            <label for="psw"><span class="glyphicon glyphicon-briefcase"></span> Student ID </label>
              <input type="text" class="form-control" id="student_id" name="student_id" placeholder="Enter password">
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
            ...
            <input type="submit" name="submit1" id="submit1" class="btn btn-success btn-block" value="SignUp">
              <!-- <button type="submit" name="submit1" id="submit1" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> SignUp</button> -->
          </form>
        </div>
        <div class="col-sm-3">
          &nbsp;
...
$sql="insert into regform(fname,lname,email,email,contact,student_id,password) values('$fname',$lname','$email','$contact','$student_id','$password')";
