...
(1, 'Hello is a song by British singer-songwriter Adele, released on 23 October 2015 by XL Recordings as the lead single from her third studio album, 25 (2015). Adele co-wrote the song with her producer, Greg Kurstin. "Hello" is a piano ballad with soul influences, and lyrics that discuss themes of nostalgia and regret.'),
(2, 'ECKY is a web developer or engineer who works with both the front and back ends of a website or application'),
(3, 'nicodemus ngufuli is a full stack developer'),
(4, 'Tanzania officially the United Republic of Tanzania is a country in East Africa within the African Great Lakes region'),
(5, 'Kenya officially the Republic of Kenya (Swahili: Jamhuri ya Kenya), is a country in Africa with 47 semiautonomous counties governed by elected governors.'),
(6, 'Jacqueline shayo is eckys wife'),
(7, 'janeth '),
(8, 'jackyson'),
(9, 'Aubrey N. Dillard'),
