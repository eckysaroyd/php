...
<html lang="en">
    <head>
        ...
        <title>doctor Nav Appointment Application</title>
        <!-- Bootstrap -->
    ...
    <body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4 col-md-4">
                                                <select name="year" class = "form-control input-lg" required>
                                                    ...
                                                    <option value="1981">1973</option>
                                                    <option value="1981">1974</option>
                                                    <option value="1981">1975</option>
                                                    <option value="1981">1976</option>
                                                    <option value="1981">1977</option>
                                                    <option value="1981">1978</option>
                                                    <option value="1981">1979</option>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 whitecolor">
                        <h2 class="whitecolor">Make appointment today!</h2>
                        <p class="whitecolor">This is Doctor's Schedule. Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Do You need Fast Service..?</h1>
                    <hr>
                    <h2>Learn From Us as We Provided Good Services To Our Customers</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Effective doctor-patient communication is a central clinical function in building a therapeutic doctor-patient relationship, which is the heart and art of medicine.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Patient to Patient Communication</h4>
                            <p>To be effective, patient education needs to be more than instructions and information. Teachers and health care providers need to be able to assess patient needs and communicate clearly..</p>
                        </div>
                    </div>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">nav technology</p>
